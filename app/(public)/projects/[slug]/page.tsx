      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
          ...
          <div className="flex items-start justify-between gap-4 mb-6">
            ...
            {(apiProject.liveUrl || apiProject.repoUrl) && (
              <Link
                ...
                className="flex items-center gap-2 px-4 py-2 border border-cyan-500 text-cyan-500 rounded-lg hover:bg-cyan-500/10 transition-colors"
              >
        ...
        {apiProject.imageUrl && (
          <div className="relative overflow-hidden rounded-lg mb-12 bg-muted aspect-video">
            <img
              src={apiProject.imageUrl}
              alt={apiProject.title}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="space-y-8">
            <div>
              <h3 className="text-sm font-medium uppercase tracking-widest mb-4 text-muted-foreground">
                Technologies
              </h3>
            </div>
            ...
            {(apiProject.liveUrl || apiProject.repoUrl) && (
              <div className="pt-8 border-t border-border">
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 border border-cyan-500 text-cyan-500 rounded-lg hover:bg-cyan-500/10 transition-colors"
                >
