    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <h1 className="text-4xl md:text-5xl font-light tracking-tight mb-4">All Projects</h1>
            <p className="text-muted-foreground">A curated list of projects (mock data).</p>
          </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-xs font-medium text-accent uppercase tracking-widest">{project.year}</span>
                    </div>
