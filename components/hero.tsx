      ...
      <div className="max-w-6xl mx-auto">
        <div className={`fade-in-up transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
          <h1 className="text-5xl md:text-7xl font-light tracking-tight mb-6 leading-tight">
            Crafting
            <span className="block text-cyan-500"> Digital Experiences</span>
          </h1>
          ...
          <div className="flex gap-4">
            <button className="px-6 py-3 bg-cyan-500 text-primary-foreground rounded-lg hover:bg-cyan-500/90 transition-colors text-sm font-medium">
              View Our Work
            </button>
